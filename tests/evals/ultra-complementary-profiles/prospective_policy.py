#!/usr/bin/env python3
"""Fail-closed authority and evidence state for Ticket 20 policy v4."""
...
def build_canonical_manifest(policy: dict[str, Any], treatment_ref: str) -> dict[str, Any]:
    """Materialize the only authority allowed to launch a v4 model cell."""
    ...
    return {
        "schema_version": 4,
        "manifest_id": "ticket-20-qoder-prospective-v4",
        "policy": {
            "id": policy["policy_id"],
