...
COMMON_EXPECTED = {
    ...
    "02-to-spec-high-risk": {"requested_route": "to-spec", "resolved_profile": "to-spec", "code": True, "research": False, "review": True, "human_choice": False, "review_iterations": 1, "evidence": "Spec is large, ambiguous, cross-system, or high-risk"},
    ...
    "04-to-tickets-external-fact": {"requested_route": "to-tickets", "resolved_profile": "to-tickets", "code": False, "research": True, "review": True, "human_choice": False, "review_iterations": 1, "evidence": "Research only when a source-verifiable external fact directly determines acceptance or a blocker"},
